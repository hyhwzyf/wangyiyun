...
access_token='24.463595b847309dcfafb7a2458640806b.2592000.1578537330.282335-17983835'  #填自己的access_token
http=urllib3.PoolManager()
url='https://aip.baidubce.com/rpc/2.0/nlp/v1/sentiment_classify?access_token='+access_token

file = pd.read_csv('output2.csv',encoding="gbk",low_memory=False)
...
for i in range(n):
    if i%50 == 0:
        print("\r进度：{:.2f}%".format(100*i/233243),end="") #虽然这句没啥用，但必须加上，要不等待太让人崩溃了，在.exe运行体验极佳。
    document = df[i:i+1]
    #print(document)
